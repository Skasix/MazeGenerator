...
class Controller
{
    ...
    static void Main()
    {
        int rowCount;
        int colCount;
        Console.WriteLine("WARNING: Larger mazes require larger windows!");
        Console.Write("Insert the maze size: ");
        returnIntInput("Invalid input. Please enter an integer.", out rowCount);
        colCount = rowCount;
